package App::Pgrep::Results::Token;
...
App::Pgrep::Results::Token - App::Pgrep result by token type.
...
OO interface to pgrep's individual results.

    use App::Pgrep::Results::Token;
...
=head3 C<new>
    ...
    my $pgrep = App::Pgrep::Results::Token->new( { 
        token   => 'pod',
...
Getter/setter for token type.  Will C<croak> if C<App::Pgrep> does not
...
sub token {
    ...
    my $token = shift;
    unless ( App::Pgrep->handler_for($token) ) {
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc App::Pgrep::Results::Token
